...
export default function Main() {
  ...
  useLayoutEffect(()=>{
    ...
    gaspScrollTrigger(imgRef1, imgRef2, textRef)
  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.box}>
        ...
        <p>평범한 일상의 순간도 더 특별하게</p>
        <p>내 일상에 필요한 서비스를 구독!</p>
        ...
        <div style={{ marginTop: "250px" }}>
          ...
          <div className={`${style.imgBoxl} ${style.after}`}>
            {imgUrl2.map((v, i) => {
              return (
                <div ref={(el)=>{
                    imgRef1.current[i + imgUrl3.length + imgUrl4.length + imgUrl1.length] = el
                  }} key={i} className={style.img}>
                  <img src={v} alt="" />
                </div>
              );
        ...
        <div className={style.contentBox2}>
          <div>
            ...
            ><div ref={(el)=>{
              ...
              <p>마음대로 고르고</p>
              <p>
                <span style={{ color: "rgb(247, 64, 134)" }}>
                  할인도 받아요
                </span>
              </p>
              </div>
...
{console.log(imgRef2)}
      ...
      <div
        style={{ height: "1800px", justifyContent: "center" }}
        className={style.box}
      >
      ...
      <div className={`${style.box} ${style.box1}`}>
        <div className={style.contentBox2}>
          ...
          <div>
            <div
              style={{ position: "relative", margin: "-20px 10px 10px 10px " }}
            >
              <img
