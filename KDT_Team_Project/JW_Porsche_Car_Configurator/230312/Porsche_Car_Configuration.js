...
function equipTotal(class_name, id) {
  var price = $(`#${id}`).attr('value')
    ...
    switch (class_name) {
     ...
     case `group10`: arr[9] = Number(price);break; 
     case `group11`: arr[10] = Number(price);break; 
     case `group12`: arr[11] = Number(price);break; 
     case `group13`: arr[12] = Number(price);break; 
     case `group14`: arr[13] = Number(price);break; 
     case `group15`: arr[14] = Number(price);break; 
  }
...
function title_value(class_name, id) {
  let title = $(`#${id}`).attr('title')
  let split=title.split("-")
  switch(class_name){
    case "group1":title_value_arr[0].innerText = split[0];break;
    case "group2":title_value_arr[1].innerText = split[0];break;
    case "group3":title_value_arr[2].innerText = split[0];break;
    case "group4":title_value_arr[3].innerText = split[0];break;
    case "group5":title_value_arr[4].innerText = split[0];break;
    case "group6":title_value_arr[5].innerText = split[0];break;
  }
}
